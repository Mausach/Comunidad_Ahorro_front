...
export const starCrearGastos = async (newUser,setRefreshData, navigate) => {
    try {
        const resp = await authApi.post('/geren/new-reg-gasto', newUser);

        Swal.fire({
            title: "Gastos registrados",
            text: "Los gastos han sido registrados exitosamente.",
            icon: "success",
            background: "#f9f9f9",
        ...
        if (errores) {
            ...
            const mensajeDeError = Object.values(errores)[0]?.msg || 'Error al registrar el gasto';
