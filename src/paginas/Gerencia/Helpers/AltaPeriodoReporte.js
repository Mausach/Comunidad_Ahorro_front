...
export const starCrearPeriodoReporte = async (fecha_inicio_periodo,fecha_fin_periodo,setRefreshData, navigate) => {
    try {
        const resp = await authApi.post('/geren/new-periodo-reporte', {
        ...
        Swal.fire({
            ...
            text: "El Periodo sido creado exitosamente.",
            icon: "success",
            background: "#f9f9f9",
        ...
        // Asegúrate de acceder correctamente a los errores
                      ...
                      if (errores) {
                          ...
                          const mensajeDeError = Object.values(errores)[0]?.msg || 'Error al crear periodo';
                          ...
                          const errorMessage = error.response?.data?.msg || 'Error al crear periodo';
                          Swal.fire({
                              title: "ERROR",
                              text: errorMessage,
                              icon: "error",
