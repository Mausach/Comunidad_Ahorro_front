...
export const ModalCrearClientePlan = ({ showCreateModal, handleCloseCreateModal, setRefreshData, navigate, usuario, reporte, cobradores, producto }) => {
